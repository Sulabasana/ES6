	    ...
	    _createClass(Mortgage, [{
	        ...
	        get: function get() {
	            ...
	            for (var y = 0; y < this.years; y++) {
	                var interestY = 0; //spłata odsetek w roku y
	                var principalY = 0; //Kwota główna kredytu w roku Y 
	                for (var m = 0; m < 12; m++) {
	                    var interestM = balance * monthlyRate; //Spłata odsetek  w miesiącu m
	                    var principalM = monthlyPayment - interestM; //Kwota kredytu w miesiącu m
